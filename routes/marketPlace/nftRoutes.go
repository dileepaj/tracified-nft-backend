...
var NftRoutes = models.Routers{
	...
	models.Router{
		...
		Path:    "/nftcollection/{blockchain}/{collection}",
	...
	models.Router{
		...
		Path:    "/nftspaginate/filterby/{type}/{blockchain}",
	...
	models.Router{
		...
		Path:    "/explore/bestcreations/{blockchain}",
	...
	models.Router{
		...
		Method:  "GET",
		Path:    "/profilecontent/{pubkey}/{blockchain}/{filter}",
