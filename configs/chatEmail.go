...
func GetAcceptedFAQEmail(category string, subject string, desc string, answer string) string {
  ...
  <tr >
      <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
        ...
        font-style: normal;
        font-weight: 400;
        font-size: 15px;"><strong>Dear User,</strong><br /><br />
        Thank you for your patience in awaiting a response. As requested, our team here at Tracified, has reviewed your query and has come up with the best possible solution.
        <br><strong>Subject : ` + subject + ` </strong>
		<br><strong>Category : ` + category + ` </strong>
		<br><strong>Question : ` + desc + ` </strong>
       <br /><br />
        Please refer below for the feedback given below.<br>
        <strong>` + answer + `</strong><br><br>
        Hope this helped. If in need of more clarification contacts us at Tracified.
      </p>
